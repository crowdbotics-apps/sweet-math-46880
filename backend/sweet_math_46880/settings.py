"""
Django settings for sweet_math_46880 project.
...
ROOT_URLCONF = 'sweet_math_46880.urls'
...
WSGI_APPLICATION = 'sweet_math_46880.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "sweet_math_46880 API",
    "DESCRIPTION": "API documentation for sweet_math_46880 App",
    "VERSION": "v1",
}
